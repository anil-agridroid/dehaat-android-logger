...
class AuthInterceptOnStartData(
    ...
    init {
        ...
        map[EventCategory.LogAuthenticatorIntercept.Info.accessTokenValid] = accessTokenValid.toString()
        map[EventCategory.LogAuthenticatorIntercept.Info.refreshTokenValid] = refreshTokenValid.toString()
        map[EventCategory.LogAuthenticatorIntercept.Info.alreadyMadeFollowRequest] = alreadyMadeFollowRequest.toString()
        map[EventCategory.LogAuthenticatorIntercept.Info.isLocalTokenValid] = isLocalTokenValid.toString()
        map[EventCategory.LogAuthenticatorIntercept.Info.lastAuthTokenUpdateTimeMillis] = lastAuthTokenUpdateTimeMillis.toString()
        map[EventCategory.LogAuthenticatorIntercept.Info.authTokenLocalValidityIntervalInSeconds] = authTokenLocalValidityIntervalInSeconds.toString()
